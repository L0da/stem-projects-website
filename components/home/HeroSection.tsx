    ...
    <section className="bg-gradient-to-b from-blue-50 to-white py-16 dark:from-gray-950 dark:to-black sm:py-20">
      <Container>
        <div className="max-w-3xl space-y-5 sm:space-y-6">
          ...
          <p className="text-base leading-7 text-gray-600 dark:text-gray-300 sm:text-lg sm:leading-8 md:text-xl">
          ...
          <div className="flex flex-col gap-3 pt-2 sm:flex-row sm:flex-wrap sm:gap-4">
            ...
            <Link
              href="/about-stem"
              className="rounded-xl border border-gray-300 px-6 py-3 text-center text-sm font-semibold text-gray-700 transition hover:bg-gray-100 dark:border-gray-700 dark:text-gray-200 dark:hover:bg-gray-800"
            >
              Learn About STEM
            </Link>
          </div>
