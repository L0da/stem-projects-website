...
export default function AboutPreviewSection() {
  return (
    <section className="bg-gray-50 py-16 dark:bg-black sm:py-20">
      <Container>
        <SectionTitle
        ...
        <div className="mx-auto max-w-3xl text-center text-base leading-7 text-gray-600 dark:text-gray-300 sm:text-lg sm:leading-8">
          <p>
